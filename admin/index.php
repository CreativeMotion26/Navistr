...
<body>
    <?php require __DIR__ . '/inc/sidebar.inc.php';?>
        ...
        <div class="px-4 pt-6 2xl:px-0">
            ...
            <!-- Right Content -->
            <div class="grid gap-4 items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex dark:border-gray-700 sm:p-6 dark:bg-gray-800flex items-center justify-between pt-3 mt-5 border-t border-gray-200 sm:pt-6 dark:border-gray-700">
                <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        ...
        <p class="my-10 text-sm text-center text-gray-500">
            &copy; 2023-05 <a href="#" class="hover:underline" target="_blank">Navistr.com</a>. All rights reserved.
        </p>
