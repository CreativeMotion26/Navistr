...
<div class="px-4 pt-6">
    ...
    <footer class="py-12 bg-white xl:py-24 dark:bg-gray-800">
        <div class="container px-4 mx-auto xl:px-0">
            ...
            <span class="block text-center text-gray-600 dark:text-gray-400">© 2019-<span id="currentYear">2023</span> <a href="#" target="_blank" rel="noreferrer">Navistr</a>. All Rights Reserved.
            </span>
        </div>
    </footer>
</div>
