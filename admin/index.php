...
<body>
    <?php require __DIR__ . '/inc/sidebar.inc.php';?>
        ...
        ---
title: Tailwind CSS Users List Page - Flowbite
...
<div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full" id="delete-user-modal">
    ...
    <p class="my-10 text-sm text-center text-gray-500">
        &copy; 2019-{{ dateFormat "2006" now }} <a href="{{ .Site.Params.homepage }}" class="hover:underline" target="_blank">Flowbite.com</a>. All rights reserved.
    </p>
</body>
</html>    