                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-1 py-4">
                                <a href="#" class="font-medium text-red-600 dark:text-red-500 hover:underline border-2 border-red-200 rounded-lg bg-gray-100 p-4">Remove</a>
                            </td>
                            <td>
                                <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline border-2 border-blue-200 rounded-lg bg-gray-100 p-4">Edit</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
