    ...
    <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    <?php $result = mysqli_query($conn,"SELECT sku, category_name, brand, type, stock FROM category");
                    while($row = mysqli_fetch_assoc($result)){?>
                        <tr class="border-b">
                            ...
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap"><?php echo $row['category_name'];?></th>
                            <td class="px-4 py-3"><?php echo $row['brand'];?></td>
                            <td class="px-4 py-3">$<?php echo $row['type'];?></td>
