          ...
          <div class="pb-4 mb-8 border-b border-gray-200 dark:border-gray-800">
            {{ if ( eq .Page.Params.requires_js true) }}
              <aside class="mb-5" aria-label="Component requires Flowbite JavaScript">
                <a href="{{ "getting-started/quickstart/" | relURL }}" class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700">
                  <span class="text-xs bg-blue-600 rounded-full text-white px-3 py-1.5 mr-3"><svg aria-hidden="true" class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></span> <span class="text-sm font-medium">Requires Flowbite JS</span> <svg class="w-4 h-4 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                </a>
              </aside>
            {{ end }}
            ...
            {{ if ( eq .Page.Params.requires_symfony true) }}
              <aside class="mb-5" aria-label="Integration requires Symfony">
                <span class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
                  <span class="text-xs rounded-full bg-white dark:bg-gray-900 px-3 py-1.5 mr-3">
            ...
            {{ if ( eq .Page.Params.requires_react true) }}
              <aside class="mb-5" aria-label="Integration requires React">
                <span class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
                  <span class="text-xs bg-blue-600 rounded-full text-white px-3 py-1.5 mr-3">
            ...
            {{ if ( eq .Page.Params.requires_remix true) }}
              <aside class="mb-5" aria-label="Integration requires Remix">
                ...
                <span class="px-3 py-1 mr-3 text-xs text-white bg-white rounded-full">
                  <svg class="w-5 h-5 text-gray-900 dark:text-white" aria-hidden="true" viewBox="0 0 140 161" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            {{ if ( eq .Page.Params.requires_nuxtjs true) }}
              <aside class="mb-5" aria-label="Integration requires Nuxt">
                <span class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
                <span class="px-3 py-px mr-3 text-xs text-white bg-white rounded-full dark:bg-gray-900">
            ...
            {{ if ( eq .Page.Params.requires_svelte true) }}
              <aside class="mb-5" aria-label="Integration requires Svelte">
                <span class="inline-flex items-center justify-between px-1 py-1 pr-4 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white">
                  <span class="text-xs bg-white dark:bg-gray-900 rounded-full text-white px-3 py-1.5 mr-3">
            ...
            <p class="mb-4 text-lg text-gray-600 dark:text-gray-400">{{ .Page.Params.Description | markdownify }}</p>
          </div>
                      ...
                      <div data-element="fields" data-stacked="false" class="flex items-center w-full max-w-md mb-3 seva-fields formkit-fields">
                          <div class="relative w-full mr-3 formkit-field">
                              ...
                              <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                <svg class="w-4 h-4 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path></svg>
                              </div>
                              <input
                                  id="member_email"
