...
<html lang="en">
   ...
   <body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
      ...
      <section class="text-gray-600 body-font overflow-hidden">
         <nav aria-label="Breadcrumb">
            <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
               ...
               <li class="text-sm">
                  <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">Leather Market Casimira Celeste</a>
               </li>
            </ol>
         </nav>
         <div class="container px-5 py-8 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
               <img alt="ecommerce" class="lg:w-full w-3/4 lg:h-auto h-3/4 object-cover object-center rounded" src="assets/images/item3.jpg">
               <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                  <h2 class="text-sm title-font text-gray-500 tracking-widest">Florentine</h2>
                  <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Red Leather Bag</h1>
                  <div class="flex mb-4">
                     <span class="flex items-center">
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 text-orange-500" viewBox="0 0 24 24">
                           <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"></path>
                        </svg>
                  ...
                  <div class="flex">
                     <span class="title-font font-medium text-2xl text-gray-900">$158.00</span>
                     <button class="flex ml-auto text-white bg-orange-500 border-0 py-2 px-6 focus:outline-none hover:bg-orange-600 rounded">BUY NOW</button>
      ...
      <main class = "container mx-auto bg-white py-8 border-t border-orange-400">
            ...
            <div class="container py-6">
               <div class="PageWidth PageWidth--large relative" style="--mobileContainerHeight:150px; --desktopContainerHeight:120px;">
                  ...
                  <div class="-textContentContainer z-10 w-full max-w-full justify-center">
                     <div class="-textContent -textContent-cover -textContent-background py-8 flex flex-col items-center">
                        <h1 class="text-2xl md:text-2xl  mb-4 ">Recommended Products</h1>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="grid grid-flow-col grid-rows-1 grid-cols-3 gap-8 " >
            <div>
