                  ...
                  <div class="textContent-cover textContent-background py-4 flex flex-col items-center">
                     <div class="flex flex-col lg:flex-row justify-between gap-8">
                        <div class="w-full lg:w-5/12 flex flex-col justify-center">
                           ...
                           <p class="font-normal text-base leading-6 text-gray-600 dark:text-white">Florentine Australia was conceived after visiting fine paper shops traditional to Florence. It was considered that Sydney deserved to experience the fine quality of stationery and accessories only found in artisan workshops of Florence and Venice and Florentine Australia was born.</p>
                        </div>
